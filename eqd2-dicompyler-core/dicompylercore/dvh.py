...
# ============================= DVH properties ============================= #
    ...
    def describe(self):
        ...
        print("Volume:    {:0.2f} {}".format(
            self.volume, self.volume_units))
        print("EQD2 Max Dose:  {:0.2f} {}".format(
            self.max, self.dose_units))
        print("EQD2 Min Dose:  {:0.2f} {}".format(
            self.min, self.dose_units))
        print("EQD2 Mean Dose: {:0.2f} {}".format(
            self.mean, self.dose_units))
        print("EQD2 D100:      {}".format(self.D100))
        print("EQD2 D98:       {}".format(self.D98))
        print("EQD2 D95:       {}".format(self.D95))
        ...
        print("EQD2 D2cc:      {}".format(self.D2cc))
        if self.notes:
